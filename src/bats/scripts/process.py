...
def main():
    ...
    OUTPUT_PARQUET = RELEASE_DIR / "bats_zooplankton_obs.parquet"
    ...
    station_lat, station_lon = 31.6, -64.2
    ...
    try:
        ...
        plt.suptitle("BATS Zooplankton Biomass (1 tow = 1 point)")
        plt.tight_layout()
    ...
    with open(REPORT_FILE, "w") as f:
        ...
        f.write("**Aggregation**: Sum of size fractions per tow (no L2 median)\n\n")
